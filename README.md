...
- [mearashadowfax/OpenStove](https://github.com/mearashadowfax/OpenStove) - A free, community-driven platform for sharing and discovering recipes. No ads, just good food!
- [saicaca/fuwari](https://github.com/saicaca/fuwari) - ✨A static blog template built with Astro.
- [araguaci/portfolio-astro](https://github.com/araguaci/portfolio-astro) - 
...
- [automatica-core/automatica](https://github.com/automatica-core/automatica) - A building managmenet system aka smart home- developed using .NET Core and Angular
...
- [AiursoftWeb/Infrastructures](https://github.com/AiursoftWeb/Infrastructures) - Mirror of: https://gitlab.aiursoft.com/aiursoft/infrastructures
- [AiursoftWeb/Kahla.Obsolete](https://github.com/AiursoftWeb/Kahla.Obsolete) - Mirror of https://gitlab.aiursoft.cn/aiursoft/Kahla
- [AiursoftWeb/Kahla](https://github.com/AiursoftWeb/Kahla) - Kahla is a cross-platform business messaging app. Mirror of https://gitlab.aiursoft.com/aiursoft/kahla
...
- [ektrah/nsec](https://github.com/ektrah/nsec) - A modern and easy-to-use cryptographic library for .NET based on libsodium
...
- [hippyaki/HealthConnect](https://github.com/hippyaki/HealthConnect) - Digital Hospital | LIVE Patient Health Dashboard Panel - Create your Account and Get Started !
- [araguaci/links](https://github.com/araguaci/links) - Organizador de Favoritos com Tema de Alta Performance
...
- [araguaci/guerra-da-informacao](https://github.com/araguaci/guerra-da-informacao) - 
...
- [araguaci/lawfare-timeline](https://github.com/araguaci/lawfare-timeline) - Somos um portal dedicado à análise investigativa e consolidada de eventos públicos. Compilamos dados de fontes confiáveis, como reportagens e relatórios do STF, TCU e MPF, para oferecer uma visão inte
...
- [araguaci/lawfare](https://github.com/araguaci/lawfare) - Análises imparciais de corrupção no judiciário brasileiro, interferências em eleições (USAID-TSE) e abusos constitucionais. Compilamos fatos públicos, cronologias e reformas para transparência e sober
- [araguaci/observatoriobrasil](https://github.com/araguaci/observatoriobrasil) - 
- [f/mcp-startup-boilerplate](https://github.com/f/mcp-startup-boilerplate) - 
- [leonardodepaula/olavodecarvalho.org](https://github.com/leonardodepaula/olavodecarvalho.org) - 
...
- [araguaci/geoengineering-patents](https://github.com/araguaci/geoengineering-patents) - registro de patentes de geoengenharia
...
- [araguaci/timeline-biowar](https://github.com/araguaci/timeline-biowar) - A Timeline of Bio-Terror  By a Concerned Reader | Published by The Exposé on April 19, 2022
...
- [theus/instantgram](https://github.com/theus/instantgram) - ☁️ A bookmarklet for download photos in Instagram
...
- [wrappixel/material-pro-angular-lite](https://github.com/wrappixel/material-pro-angular-lite) - The Most Powerful & Easy-to-Use Free Angular Admin Template Built on Material Angular 20 🚀,
...
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) - (Deprecated) Home of the MDN live code editor interactive examples
...
- [araguaci/cursor-skills](https://github.com/araguaci/cursor-skills) - CURSOR IDE best practices and guidelines
...
- [araguaci/surfweb](https://github.com/araguaci/surfweb) - 
...
- [linus-sch/Mind-Map-Wizard](https://github.com/linus-sch/Mind-Map-Wizard) - Create mind maps using artificial intelligence. No distractions, just that.
...
- [charming-art/api](https://github.com/charming-art/api) - A lightweight data-driven API for manipulating SVG, Canvas and HTML.
...
- [aimeos/aimeos-headless](https://github.com/aimeos/aimeos-headless) - Aimeos cloud-native, API-first ecommerce headless distribution based on Laravel 11 for ultra fast online shops, scalable marketplaces, complex B2B applications and #gigacommerce
...
- [Basharath/FormEasy](https://github.com/Basharath/FormEasy) - An open-source library to receive forms for static sites using Google Apps Script
...
- [yiisoft/docs](https://github.com/yiisoft/docs) - Official documentation for Yii3 Framework
...
- [maykbrito/electron-desktop-custom-notion-omni](https://github.com/maykbrito/electron-desktop-custom-notion-omni) - Inject custom JS/CSS to beautify and add functions to Notion.so
...
- [yangshun/tree-node-cli](https://github.com/yangshun/tree-node-cli) - List directory contents in a tree-like format, similar to the Linux tree command
...
- [Maxzilla60/Spelling-with-Elements](https://github.com/Maxzilla60/Spelling-with-Elements) - ⚗️ Spell out a word using the elements on the periodic table!
...
- [tomekvenits/react-native-map-clustering](https://github.com/tomekvenits/react-native-map-clustering) - React Native map clustering both for Android and iOS.
- [tomekvenits/react-native-login-template](https://github.com/tomekvenits/react-native-login-template) - Simple login template for React Native.
...
- [cssorlandi/app-tipo-ifood](https://github.com/cssorlandi/app-tipo-ifood) - 
...
- [stefangabos/Zebra_Dialog](https://github.com/stefangabos/Zebra_Dialog) - A small, compact, mobile-friendly and highly configurable jQuery plugin for creating gorgeous dialog boxes
...
- [versatica/tryit-jssip](https://github.com/versatica/tryit-jssip) - tryit-jssip application
...
- [araguaci/ai-engineering-hub](https://github.com/araguaci/ai-engineering-hub) - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
- [Google-Health/medasr](https://github.com/Google-Health/medasr) - 
...
- [ArvorCo/AssistancesUSA2025](https://github.com/ArvorCo/AssistancesUSA2025) - 
...
- [materialyzeai/matgenb](https://github.com/materialyzeai/matgenb) - Jupyter notebooks demonstrating the utilization of open-source codes for the study of materials science.
...
- [Vampire/setup-wsl](https://github.com/Vampire/setup-wsl) - A GitHub action to install and setup a Linux distribution for the Windows Subsystem for Linux (WSL)
...
- [HaxeFlixel/haxeflixel.com](https://github.com/HaxeFlixel/haxeflixel.com) - haxeflixel.com 11ty source
...
- [Lissy93/permissionator](https://github.com/Lissy93/permissionator) - 🐧 A Linux chmod calculator, for generating safe file permissions
...
- [SeuAliado/OpenCEP](https://github.com/SeuAliado/OpenCEP) - WebService com Gateway de CEP Grátis para E-Commerce, ERP, NFe!
...
- [mickimnet/myth-prompt-themes](https://github.com/mickimnet/myth-prompt-themes) - M.y.t.h. theme collection for powerline prompts
...
- [mtahiraslan/data-analyst-roadmap](https://github.com/mtahiraslan/data-analyst-roadmap) - Based on my own experience, I believe this roadmap provides clear answers to all the key questions about becoming a data analyst from scratch, including which technologies and programming languages to
...
- [araguaci/osTicket](https://github.com/araguaci/osTicket) - The osTicket open source ticketing system official project repository, for versions 1.8 and later
...
- [julien-boudry/Condorcet](https://github.com/julien-boudry/Condorcet) - Versatile PHP election engine (library & CLI) with a high-level API. Handles everything from the simplest use cases to advanced options and simulation tools. Supports 20+ native Condorcet-like voting 
...
- [pagseguro/pagseguro-modulo-prestashop](https://github.com/pagseguro/pagseguro-modulo-prestashop) - Módulo de Checkout Transparente para integração com PrestaShop 1.6.x ao 9.x - Oficial PagBank
...
- [lbr38/repomanager](https://github.com/lbr38/repomanager) - A web UI to mirror rpm and deb repositories.
...
- [benbalter/wordpress-static-site-exporter](https://github.com/benbalter/wordpress-static-site-exporter) - One-click WordPress plugin that converts all posts, pages, taxonomies, metadata, and settings to Markdown and YAML which can be dropped into Jekyll (or Hugo or any other Markdown and YAML based site e
...
- [XOOPS/XoopsCore26](https://github.com/XOOPS/XoopsCore26) - Core Framework for next version of XOOPS CMS: 2.6.0
...
- [iNextrix/ASTPP](https://github.com/iNextrix/ASTPP) - Open Source VoIP Billing Solution http://www.astppbilling.org | Report a bug https://inextrix.atlassian.net/jira/projects
...
- [nfe/whmcs-addon](https://github.com/nfe/whmcs-addon) - Módulo Nota Fiscal para WHMCS via NFE.io. Automatizar emissão de notas fiscais.
...
- [codedbytati/gaia-sustentavel](https://github.com/codedbytati/gaia-sustentavel) - projeto integrador do curso de desenvolvimento web full stack na digital house.
...
- [lfnovo/esperanto](https://github.com/lfnovo/esperanto) - A unified interface for various AI model providers
...
- [araguaci/anthropic-skills](https://github.com/araguaci/anthropic-skills) - Public repository for Skills
...
- [ZeroXClem/Youtube-to-Markdown](https://github.com/ZeroXClem/Youtube-to-Markdown) - YouTube video transcripts into readable Markdown format with paragraph formatting.
...
- [khromalabs/ainara](https://github.com/khromalabs/ainara) - Evolving, Collaborative, Local AI Partners Framework
- [pyinstaller/pyinstaller](https://github.com/pyinstaller/pyinstaller) - Freeze (package) Python programs into stand-alone executables
- [seapagan/fastapi-template](https://github.com/seapagan/fastapi-template) - A Configurable template for a FastAPI application, with Authentication, User integration, Caching, Logging, Admin pages and a snappy CLI to control it all!
- [seapagan/py-maker](https://github.com/seapagan/py-maker) - A fully customizable Python application to bootstrap Poetry-based boilerplate for you to start developing your Python applications quicker! Includes linting and Pytest libraries.
- [janosh/matbench-discovery](https://github.com/janosh/matbench-discovery) - An evaluation framework for machine learning models simulating high-throughput materials discovery.
...
- [radioconda/radioconda-installer](https://github.com/radioconda/radioconda-installer) - Software radio distribution and installer for conda
...
- [kongdd/linux-config](https://github.com/kongdd/linux-config) - System Init
...
- [ozh/top_100_PHP_projects](https://github.com/ozh/top_100_PHP_projects) - 💯 The 𝗧𝗼𝗽 𝟭𝟬𝟬 𝗣𝗛𝗣 Projects on Github
...
- [app-generator/flask-soft-ui-dashboard](https://github.com/app-generator/flask-soft-ui-dashboard) - Flask Soft Dashboard - Open-Source Starter | App-Generator.dev
...
- [snapshot-labs-archived/snapshot-spaces](https://github.com/snapshot-labs-archived/snapshot-spaces) - 
...
- [hr0ark/artix-rootfs](https://github.com/hr0ark/artix-rootfs) - Artix Linux rootfs & Windows WSL (WSL2) installation
...
- [slackjeff/make-debian-live](https://github.com/slackjeff/make-debian-live) - Utilizando live-build debian.
...
- [araguaci/notebooklm-PESTEL](https://github.com/araguaci/notebooklm-PESTEL) - 🌍 Análise PESTEL Aplicações no Mercado Moderno
...
- [araguaci/notebooklm-5W2H](https://github.com/araguaci/notebooklm-5W2H) - 📋 5W2H Do Planejamento à Execução
- [araguaci/notebooklm-showcase](https://github.com/araguaci/notebooklm-showcase) - 🛰️ SWOT: Da Estratégia Empresarial ao Monitoramento Oceânico Global
- [araguaci/notebooklm-SWOT](https://github.com/araguaci/notebooklm-SWOT) - 🛰️ SWOT: Da Estratégia Empresarial ao Monitoramento Oceânico Global
...
- [araguaci/open-notebook](https://github.com/araguaci/open-notebook) - An Open Source implementation of Notebook LM with more flexibility and features
- [lfnovo/open-notebook](https://github.com/lfnovo/open-notebook) - An Open Source implementation of Notebook LM with more flexibility and features
- [GeekyAnts/recordpanel](https://github.com/GeekyAnts/recordpanel) - A JS/TS SDK to collect audio, video & screen capture for your apps!
- [araguaci/design-fundamentals](https://github.com/araguaci/design-fundamentals) - Design Fundamentals - UI Design Education Platform
- [araguaci/sharecard](https://github.com/araguaci/sharecard) - Gerador profissional de imagens para redes sociais com 22 temas visuais e múltiplos formatos
...
- [araguaci/colanode](https://github.com/araguaci/colanode) - Open-source and local-first Slack and Notion alternative that puts you in control of your data
...
- [AstraOnlineWeb/astracampaign](https://github.com/AstraOnlineWeb/astracampaign) - Astra Campaign é uma plataforma SaaS open-source para campanhas em massa no WhatsApp. Multi-tenant com isolamento por empresa, quotas, backup automático, integração com IA para personalização e suport
...
- [akasuv/neoland](https://github.com/akasuv/neoland) - Find the best Neovim resources on NeoLand 🧙
...
- [CalculatorBit/SnapFromWeb](https://github.com/CalculatorBit/SnapFromWeb) - Create Screenshot from URL
...
- [GervinFung/periotable](https://github.com/GervinFung/periotable) - Periotable, The Modern Periodic Table
...
- [alex-streza/rora](https://github.com/alex-streza/rora) - 
...
- [iamsurajchahar/Json_Tree](https://github.com/iamsurajchahar/Json_Tree) - Json Tree: Visualize JSON data in graph and tree forms. Simplify, explore, and customize effortlessly. Lightning-fast rendering, browser-friendly, and developer-ready. Empower your data exploration.
...
- [kernoeb/PlanningSup](https://github.com/kernoeb/PlanningSup) - Votre calendrier universitaire, simple, rapide, efficace
...
- [sadanandpai/clearfrontend](https://github.com/sadanandpai/clearfrontend) - 
...
- [jahirfiquitiva/jahir.dev](https://github.com/jahirfiquitiva/jahir.dev) - My (previous) personal website ☻  –  Built using Next.js, TypeScript, Tailwind CSS and MDX
...
- [lume/lume](https://github.com/lume/lume) - GPU-powered 3D HTML. ✨🧊 &lt;lume-box size="1 2 3"&gt;
...
- [PrairieLearn/PrairieLearn](https://github.com/PrairieLearn/PrairieLearn) - Online problem-driven learning system
...
- [glen-cheney/react-stacked-elements](https://github.com/glen-cheney/react-stacked-elements) - Toggle the visibility of two elements without removing them from the document layout
...
- [Maxzilla60/Animal-Crossing-Villager-Lister](https://github.com/Maxzilla60/Animal-Crossing-Villager-Lister) - Animal Crossing ★ Villager Lister
...
- [tomekvenits/react-native-firebase-login-template-typescript](https://github.com/tomekvenits/react-native-firebase-login-template-typescript) - React Native Login Template with Firebase Authorization and Typescript support.
...
- [abacritt/angularx-social-login](https://github.com/abacritt/angularx-social-login) - Social login and authentication module for Angular 19
...
- [brazilian-utils/javascript](https://github.com/brazilian-utils/javascript) - Utils library for specific Brazilian businesses
...
- [stefanoslig/angular-ngrx-nx-realworld-example-app](https://github.com/stefanoslig/angular-ngrx-nx-realworld-example-app) - Real world application built with Angular 21, NgRx 21, nrwl/nx 22
...
- [xieguigang/sciBASIC](https://github.com/xieguigang/sciBASIC) - sciBASIC# is a kind of dialect language which is derive from the native VB.NET language, and written for the data scientist.
...
- [openhab/openhab-website](https://github.com/openhab/openhab-website) - This repository contains the final artifacts from which the project website is served.
...
- [sfxcode/nuxt-primevue-starter](https://github.com/sfxcode/nuxt-primevue-starter) - Build your VUE.js App with Nuxt 4 . First Class PrimeVUE 4 support. Formkit Validation included.
- [sfxcode/vite-primevue-starter](https://github.com/sfxcode/vite-primevue-starter) - VUE 3 Starter project for using primevue 4.x with Vite 7 - Pages, Layouts, Validation
